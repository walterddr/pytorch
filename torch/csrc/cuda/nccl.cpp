...
ncclComm_t* to_nccl_comms(torch::cuda::nccl::ncclComm_t* var) {
...
ncclResult_t to_nccl_result(torch::cuda::nccl::ncclResult_t var) {
  switch (var) {
    case torch::cuda::nccl::ncclResult_t::ncclSuccess:
      return ncclResult_t::ncclSuccess;
    case torch::cuda::nccl::ncclResult_t::ncclUnhandledCudaError:
      return ncclResult_t::ncclUnhandledCudaError;
    case torch::cuda::nccl::ncclResult_t::ncclSystemError:
      return ncclResult_t::ncclSystemError;
    case torch::cuda::nccl::ncclResult_t::ncclInternalError:
      return ncclResult_t::ncclInternalError;
    case torch::cuda::nccl::ncclResult_t::ncclInvalidArgument:
      return ncclResult_t::ncclInvalidArgument;
    case torch::cuda::nccl::ncclResult_t::ncclInvalidUsage:
      return ncclResult_t::ncclInvalidUsage;
    case torch::cuda::nccl::ncclResult_t::ncclNumResults:
...
torch::cuda::nccl::ncclResult_t from_nccl_result(ncclResult_t var) {
    switch (var) {
    case ncclSuccess:
      return torch::cuda::nccl::ncclResult_t::ncclSuccess;
    case ncclUnhandledCudaError:
      return torch::cuda::nccl::ncclResult_t::ncclUnhandledCudaError;
    case ncclSystemError:
      return torch::cuda::nccl::ncclResult_t::ncclSystemError;
    case ncclInternalError:
      return torch::cuda::nccl::ncclResult_t::ncclInternalError;
    case ncclInvalidArgument:
      return torch::cuda::nccl::ncclResult_t::ncclInvalidArgument;
    case ncclInvalidUsage:
      return torch::cuda::nccl::ncclResult_t::ncclInvalidUsage;
    case ncclNumResults:
      return torch::cuda::nccl::ncclResult_t::ncclNumResults;
    default:
      throw std::runtime_error("Unconvertible NCCL type");
  }
}
...
void throw_nccl_error(torch::cuda::nccl::ncclResult_t status) {
  std::ostringstream err;
  err << "NCCL Error " << status << ": " << ncclGetErrorString(to_nccl_result(status));
...
struct NcclCommList {
  ...
  NcclCommList(const std::vector<int>& devices)
    ...
    NCCL_CHECK(from_nccl_result(
      ncclCommInitAll(to_nccl_comms(comms.get()), devices.size(), devices.data())));
  }
